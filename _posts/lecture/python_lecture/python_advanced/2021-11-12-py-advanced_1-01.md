...
```
    ...
    자동차1의 색상은빨강이며, 현재속도는 30km입니다.
    자동차2의 색상은파랑이며, 현재속도는 60km입니다.
    자동차3의 색상은노랑이며, 현재속도는 0km입니다.
...
# print(f'{car1.name}의 현재 속도는 {car1.speed}이고 색상은{car1.color}입니다')
# print(f'{car2.name}의 현재 속도는 {car2.speed}이고 색상은{car2.color}입니다')
...
```
    ...
    차량 속도 :  0
    차량 색상 :  black
    Audi의 현재 속도는 0이고 색상은black입니다
    차량 이름 :  Benz
    차량 속도 :  30
    차량 색상 :  white
    Benz의 현재 속도는 30이고 색상은white입니다
